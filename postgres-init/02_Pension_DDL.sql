...
CREATE TABLE IF NOT EXISTS cts_pension.ppo_status_flags (
  ...
  treasury_code character varying(3) NOT NULL,
	ppo_id integer NOT NULL,
  ppo_approved_flag boolean DEFAULT false,
  ppo_approved_wef date,
  health_scheme_flag boolean DEFAULT false,
  health_scheme_wef date,
  first_pension_flag boolean DEFAULT false,
  first_pension_wef date,
  double_pension_flag boolean DEFAULT false,
  double_pension_wef date,
  employeed_flag boolean DEFAULT false,
  employeed_wef date,
  reemployed_flag boolean DEFAULT false,
  reemployed_wef date,
  adhoc_pension_flag boolean DEFAULT false,
  adhoc_pension_wef date,
  interim_pension_flag boolean DEFAULT false,
  interim_pension_wef date,
  shared_pension_flag boolean DEFAULT false,
  shared_pension_wef date,
  status_active_flag boolean DEFAULT false,
  status_active_wef date,
	created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  created_by integer,
  updated_at timestamp without time zone DEFAULT NULL,
  updated_by integer,
