...
CREATE TABLE cts_pension.treasuries (
  id bigserial NOT NULL PRIMARY KEY,
  treasury_code character varying(4) NOT NULL UNIQUE,
  treasury_name character varying(100),
  district_code character varying(2),
  treasury_address character varying(200),
  ...
  int_treasury_code character varying(5),
  pension_flag char(1),
  created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  created_by integer NOT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS cts_pension.pensioners (
  ...
  nfp_amount integer,
  nfp_wef_date date,
  notional_pension_amount integer,
  notional_wef_date date,
  gpf_tpf_no character varying(100),
  pensioner_status character varying(100),
  first_pension_generated boolean default false,
  health_scheme boolean default false,
  employed_pensioner boolean default false,
  re_employed_pensioner boolean default false,
  double_pension boolean default false,
  adhoc_pension boolean default false,
  provisional_pension boolean default false,
  interim_allowance boolean default false,
  shared_pension boolean default false,
...
CREATE TABLE IF NOT EXISTS cts_pension.life_certificates (
  ...
  pensioner_id bigint NOT NULL references cts_pension.pensioners(id),
  ppo_id integer NOT NULL,
  digital_mode boolean default false,
...
CREATE TABLE IF NOT EXISTS cts_pension.ppo_bills (
  ...
  correction_status CHAR(1) NOT NULL,
  failed_reason character varying(500),
  remarks character varying(500),
  created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  created_by integer NOT NULL,
  updated_at timestamp without time zone DEFAULT NULL,
