...
(   "INT_PEN_NOM_ID" bigserial NOT NULL, 
...
(	"INT_PENSIONER_ADDR_ID" bigserial NOT NULL, 
	"INT_EMPLOYEE_ID" integer NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"HOUSE_NO_STREET_LANE" character varying(100), 
	"CITY_TOWN_VILLAGE" character varying(100), 
	...
	"PIN" character varying(10), 
	"WEF" DATE, 
	"ADDR_TYPE" character varying(5) DEFAULT 'PM' NOT NULL, 
...
(	"INT_COPY_FORWARD_ID" bigserial NOT NULL, 
...
(	"INT_PEN_FORWARDING_ID" bigserial NOT NULL , 
	"INT_PENSIONER_ID" integer, 
	"SL_NO" integer, 
...
(	"INT_PEN_PREP_ATTACHEMENT" bigserial NOT NULL , 
...
(	"INT_PREP_CALCULATED_AMT_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
...
(	"INT_PEN_PREP_CALC_HDR_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"INT_PEN_PREP_CALC_HEADER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
	"REQUEST_ID" integer NOT NULL, 
...
(	"INT_PEN_PREP_EML_DTLS_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"INT_PEN_PREP_CALC_HEADER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
...
(	"INT_PEN_OTH_OUTSTANDING_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"INT_PEN_PREP_CALC_HEADER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
...
(	"INT_PEN_OUTSTANDING_LOAN_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"INT_PEN_PREP_CALC_HEADER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
...
(	"INT_PEN_OUTSTND_LOAN_DTL_ID" bigserial NOT NULL, 
...
(	"INT_PEN_PREP_PAY_DTLS_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"INT_PEN_PREP_CALC_HEADER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
...
(	"INT_PEN_PROV_PENSION_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
...
(	"INT_PEN_SERVICE_DTLS_ID" integer NOT NULL, 
	...
	"REMARKS" character varying(100), 
	"MODIFIABLE_FLAG" character varying(1) NOT NULL, 
	"PERIOD_TYPE" character varying(6) NOT NULL, 
	"QUAL_NON_QUAL_WEIGHTAGE_TYPE" character varying(2) NOT NULL, 
	"ACTIVE_FLAG" character varying(1) NOT NULL, 
	"REQUEST_ID" integer NOT NULL, 
	"DML_STATUS_FLAG" integer DEFAULT 0 NOT NULL, 
	"CREATED_USER_ID" integer DEFAULT 0 NOT NULL, 
...
(	"INT_FRWDING_LIST_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer, 
	"REPORT_NAME" character varying(200) NOT NULL, 
	"REPORT_ABBR" character varying(5), 
	"ACTIVE_FLAG" character varying(5) NOT NULL, 
	"IN_USER_ID" integer NOT NULL, 
	"PEN_TYPE_ID" integer, 
	"PEN_TYPE_ABBR" character varying(3), 
	"MANDATORY_FLAG" character varying(5), 
	"CREATED_TIMESTAMP" timestamp without time zone DEFAULT CURRENT_TIMESTAMP, 
	"ODR_SL_NO" integer, 
...
(	"INT_BENF_TYPE_REL_MAP_ID" bigserial NOT NULL, 
	"BENF_TYPE_ID" integer NOT NULL, 
...
(	"INT_PEN_COMMUTATION_RATE_ID" bigserial NOT NULL, 
...
(	"INT_HOA_MAP_ID" bigserial NOT NULL, 
...
(	"INT_PEN_PREP_ATTACHEMENT" bigserial NOT NULL, 
	...
	"OPTIONAL_MANDATORY_FLAG" character varying(3) NOT NULL, 
	"ACTIVE_FLAG" character varying(1) NOT NULL, 
	"DML_STATUS_FLAG" integer DEFAULT 0 NOT NULL, 
	"USER_ID" integer DEFAULT 0 NOT NULL, 
	"CREATED_TIMESTAMP" timestamp without time zone DEFAULT CURRENT_TIMESTAMP, 
...
(	"INT_PEN_PREP_CALC_HEADER_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"ITERATION_NO" integer NOT NULL, 
	"ACTIVE_FLAG" character varying(1) NOT NULL, 
	"REQUEST_ID" integer NOT NULL, 
...
(	"INT_PREP_DECLARATION_ID" bigserial NOT NULL, 
...
(	"INT_PENSIONER_ID" bigserial NOT NULL, 
	...
	"EMP_GENDER_OBS" character varying(1), 
	"INT_MARITAL_STATUS_ID" integer, 
	...
	"FINAL_GPF_APPLIED_FLAG" CHAR(1) DEFAULT 'N' NOT NULL, 
	...
	"COURT_CASE_PENDING_STATUS" character varying(1), 
	...
	"FAMILY_PENSIONER_EMPLOYED_FLAG" character varying(1), 
	...
	"OTHER_PENSION_RECEIPT_FLAG" character varying(1), 
	...
	"RE_EMPLOYED_AFTER_RETIRE_FLAG" character varying(1), 
	"FAMILY_PEN_RCPT_OTH_PEN_FLAG" character varying(1), 
	"PROVISIONAL_PEN_RECEIVED_FLAG" character varying(1), 
	"PROVISIONAL_GRATUITY_RCVD_FLAG" character varying(1), 
	"VIGILANCE_CASE_PENDING_FLAG" character varying(1), 
	"DEPT_CRIMINAL_PROC_PENDING_FLG" character varying(1), 
...
(	"PROCESSING_FLAG" bigserial NOT NULL, 
...
(	"BENF_TYPE_ID" bigserial NOT NULL, 
...
(	"INT_PEN_RULE_DTLS_ID" bigserial NOT NULL, 
	"INT_PEN_RULE_NAME_ID" integer NOT NULL, 
...
(	"INT_PEN_RULE_NAME_ID" bigserial NOT NULL, 
...
(	"INT_PEN_RULE_SUB_DTLS_ID" bigserial NOT NULL, 
	"INT_PEN_RULE_DTLS_ID" integer NOT NULL, 
...
(	"INT_ATTACHEMENT_DTL_ID" bigserial NOT NULL, 
	"DOCUMENT_ID" integer NOT NULL, 
	"CONTENT_ID" character varying(38) NOT NULL, 
	"INT_EMPLOYEE_ID" integer NOT NULL, 
	"ACTIVE_FLAG" character varying(1) DEFAULT 'Y' NOT NULL, 
...
(	"INT_FAMILY_ADDR_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer, 
...
(	"INT_PREP_FAMILY_PEN_DTL" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer NOT NULL, 
	"FAMILY_ID" integer NOT NULL, 
...
(	"PEN_FILE_PROCESS_LOG_ID" bigserial NOT NULL, 
	"INT_PENSIONER_ID" integer, 
